...
---
> [!abstract] 摘要
> 本笔记介绍 C 语言中的基本数据类型、变量定义、类型转换、作用域与存储期。
...
- [[C - 运算符、sizeof 与 const]]：集中说明表达式、位操作、对象大小和只读接口。
- [[C 标准库 - stdio.h]]：继续学习 `printf`、`scanf` 与格式化输入输出。
...
## 🕸️ Relation
### C语言知识体系
* [[MOC - C|C语言知识体系]] - 本笔记是C语言的基础核心
* [[C - 控制流]] - 控制流中会大量使用数据类型和变量
* [[C - 函数]] - 函数参数和返回值涉及类型转换
* [[C - 数组]] - 数组需要理解数据类型的概念
* [[C - 指针]] - 指针类型与数据类型密切相关

### 相关主题
* [[C 标准库 - stdio.h]] - 格式化输入输出的详细说明
