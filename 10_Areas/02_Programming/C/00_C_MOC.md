...
### C语言标准库 (Standard Library)

#### 核心库函数详解
- [[C语言标准库 - stdio.h详解]] - 文件IO、格式化输入输出（printf/scanf）、缓冲控制
- [[C语言标准库 - stdlib.h详解]] - 内存管理（malloc/free）、类型转换、排序搜索、随机数
- [[C语言标准库 - string.h详解]] - 字符串操作（strcpy/strcmp）、内存操作（memcpy/memset）
- [[C语言标准库 - math.h详解]] - 数学函数、三角函数、指数对数、取整函数
- [[C语言标准库 - time.h详解]] - 时间日期处理、时间戳、格式化输出

### 高级主题 (Advanced)

#### 设计模式与架构
- [[C语言高级 - 状态机设计模式]] - 状态机实现、查找表、函数指针、实战案例（TCP/电梯控制）

### Linux系统编程

#### 文件IO
- [[Linux系统编程 - 文件IO]] - open、read、write、close、lseek、fcntl
- [[Linux系统编程 - 文件系统]] - 文件权限、目录操作

#### 进程与线程
- [[Linux系统编程 - 进程管理]] - fork、exec、wait、ELF格式、内存布局（栈/堆）
...
3. **标准库阶段** (1-2周)
   - 熟练使用stdio.h（文件IO和格式化输入输出）
   - 掌握stdlib.h（内存管理、类型转换）
   - 理解string.h（字符串和内存操作）
   - 学习常用数学和时间函数
